...
Trajectory Generation:
    ...
    - Auto-calculates safe durations respecting 60°/s velocity limit
...
def validate_trajectory_velocity(trajectory, max_velocity_deg_per_sec=60.0):
    """
...
def generate_test_trajectory(start_angle=0.0, end_angle=45.0):
    ...
    min_duration_sec = (angle_change * 2.0) / 60.0  # 60°/s max velocity
