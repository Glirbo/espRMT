...
//   10° move = 5,556 steps
//   5° move = 2,778 steps
// Buffer sized for ESP32-WROOM memory constraints (costs ~37KB RAM)
// WROOM has 520KB SRAM total - must leave room for system + stack + heap
#define MAX_RMT_ITEMS 3072  // Supports up to ~5.5° moves in 50ms at 30°/s
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "╔════════════════════════════════════════════════════════╗");
    ESP_LOGI(TAG, "║                                                        ║");
    ESP_LOGI(TAG, "║   ESP32-WROOM ROBOTIC ARM CONTROLLER v1.0              ║");
    ESP_LOGI(TAG, "║                                                        ║");
    ESP_LOGI(TAG, "╚════════════════════════════════════════════════════════╝");
    ESP_LOGI(TAG, "");
